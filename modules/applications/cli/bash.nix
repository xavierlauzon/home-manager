  ...
  config = mkIf cfg.enable {
    ...
    programs = {
      bash = {
        ...
        initExtra = ''
          alias hmpull="home-manager switch --flake github:xavierlauzon/home-manager/#\$HOSTNAME.\$USER --extra-experimental-features 'nix-command flakes' --refresh --no-write-lock-file"
